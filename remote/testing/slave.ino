...
// measure power load every POWER_LOAD_PICK_TIME ms
#define POWER_LOAD_PICK_TIME    100
// create an average value every POWER_LOAD_AVG_PICK_COUNT measure
#define POWER_LOAD_AVG_PICK_COUNT   10
int power_load_sum 	  = 0;
int power_load_count  = 0;
char power_load_avg   = 0;
int power_load_last   = 0;			// last power measure
...
void input_read()
{
  ...
  {
    char b = power_status() ? CMD_POWER_OFF : CMD_POWER_ON;
    handle_byte(b, SOURCE_INPUT);
    handle_byte(b, COMMAND_VALIDATE);
  }
}
